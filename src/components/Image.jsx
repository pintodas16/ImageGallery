...
function Image({ image, onUpdateImage, totalImages, coverImg }) {
  console.log(image);
  return (
    <div
      className={`relative group border-2 rounded-md hover:bg-gray-500 ${
        image.id === coverImg ? "col-span-2 row-span-2" : ""
      } overflow-hidden bg-cover bg-no-repeat`}
    >
      <img className=" w-full rounded-md" src={image.src} alt="" />
